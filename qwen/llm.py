# 创建一个修改后的 QwenCLIPLMDBGenerator 类，重点修改多模态输入处理部分
code_content = '''
import torch
...
# 保存重构后的代码
with open('/home/stu_b/BIKE/qwen/Processor.py', 'w', encoding='utf-8') as f:
    f.write(code_content)

print("📁 重构后的代码已保存到 improved_qwen_clip_generator.py")