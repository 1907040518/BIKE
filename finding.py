...
# 保存修改后的测试文件
with open('/home/stu_b/BIKE/test_modified.py', 'w') as f:
...
with open('/home/stu_b/BIKE/test_summary.md', 'w') as f:
    f.write(modifications_summary)

print("🎉 测试文件修改完成！")
print("\n🔧 主要修改:")
print("   • 三模态数据处理 (images, mvs, residuals)")
print("   • 双头结构 (video_head + mv_head)")
print("   • 特征加权融合 (beta权重 + 0.4/0.6融合)")
print("   • 压缩数据集支持")
print("   • 权重加载适配")

print("\n📄 文件:")
print("   • test_modified.py - 修改后的测试文件")
print("   • test_modifications_summary.md - 详细修改说明")
